...
AWS_ACCOUNT_ID="${AWS_ACCOUNT_ID:-}" # It differs to AWS_ACCESS_KEY_ID.
AWS_PROFILE_NAME="${AWS_PROFILE_NAME:-default}"
AWS_APP_NAME="${AWS_APP_NAME:-myapp}"
AWS_PWD="$PWD/resources/$AWS_PROFILE_NAME/$AWS_APP_NAME"
alias aws='aws --profile $AWS_PROFILE_NAME'
